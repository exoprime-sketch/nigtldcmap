...
// A-023: rows per registry and rows with a coordinate.
{
  ...
  // V140: the detail leads with the per-registry facility counts; the row
  // total (1,963) is a source note below the fuel table, outside the
  // representative text the screen review captures, and is compared on the
  // map surface instead.
