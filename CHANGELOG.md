...
- 2026-09-22 입고분으로 106개 요소 갱신(요소 152개 중 변화 45). B-003·B-017·C-003·C-005·C-025·B-045·B-038·A-030 증가, B-009 감소
...
- 39개 요소는 구조·범위·한도·계약 불일치로 보류하고 이전 입고분 값을 유지(사유: `reports/v156/hold-list-v156.json`)
