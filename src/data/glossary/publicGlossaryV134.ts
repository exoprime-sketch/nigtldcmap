...
const REQUIRED_PUBLIC_GLOSSARY_V134: PublicGlossaryEntryV134[] = [
  ...
  seedV134({
    ...
    category: "unit",
    aliases: ["MtCO2e", "MtCO₂eq", "MtCO2eq", "Mt CO2eq", "Mt CO₂eq", "백만 tCO₂e", "백만톤CO2e"],
  }),
  seedV134({
    id: "celsius",
    term: "°C",
...
const CATALOG_PUBLIC_GLOSSARY_V134: PublicGlossaryEntryV134[] = [
  ...
  // V141: initiatives, programmes and codes named on the C-007/C-008/C-018/C-025 screens.
  seedV134({ id: "a6ip", term: "A6IP", englishName: "Paris Agreement Article 6 Implementation Partnership", koreanName: "파리협정 6조 이행 파트너십", definition: "파리협정 제6조 탄소시장·비시장 협력의 이행을 지원하는 국가·기관 파트너십입니다.", category: "climate-policy" }),
  seedV134({ id: "asap", term: "ASAP", englishName: "Adaptation for Smallholder Agriculture Programme", koreanName: "소농 적응 프로그램", definition: "국제농업개발기금(IFAD)이 운영하는 소농 기후적응 지원 프로그램입니다.", category: "development-finance" }),
  seedV134({ id: "ccich", term: "CCICH", englishName: "Climate Change Impacts on Cultural and Natural Heritage", koreanName: "문화·자연유산 기후변화 영향 이니셔티브", definition: "기후변화가 문화·자연유산에 미치는 영향을 다루는 국제 협력 이니셔티브입니다.", category: "climate-policy" }),
  seedV134({ id: "cmbp", term: "CMBP", englishName: "Common Microbial Biotechnology Platform", koreanName: "공동 미생물 생명공학 플랫폼", definition: "기후행동 포털(NAZCA)에 등재된 미생물 생명공학 협력 플랫폼입니다.", category: "organisation" }),
  seedV134({ id: "uef", term: "UEF", englishName: "Ho Chi Minh City University of Economics and Finance", koreanName: "호치민시 경제금융대학교", definition: "기후행동 포털(NAZCA)에 등재된 베트남 대학입니다.", category: "organisation" }),
  seedV134({ id: "cefia", term: "CEFIA", englishName: "Cleaner Energy Future Initiative for ASEAN", koreanName: "아세안 청정에너지 미래 이니셔티브", definition: "일본이 제출한 파리협정 6.8조 비시장접근법으로, 아세안 역내 청정에너지 협력 모델입니다.", category: "climate-policy" }),
  seedV134({ id: "siva", term: "SIVA", englishName: "SIVA Cuba non-market approach", koreanName: "SIVA 쿠바 비시장접근법", definition: "쿠바가 제출해 UNFCCC NMA 플랫폼에 등재된 비시장접근법의 명칭입니다.", category: "climate-policy" }),
  seedV134({ id: "sin-sequia", term: "SIN", englishName: "SIN-Sequía Cuba non-market approach", koreanName: "SIN-Sequía 쿠바 비시장접근법", definition: "쿠바가 제출해 UNFCCC NMA 플랫폼에 등재된 가뭄 대응 비시장접근법의 명칭입니다.", category: "climate-policy" }),
  seedV134({ id: "abm", term: "ABM", englishName: "ABM Uganda non-market approach", koreanName: "ABM 우간다 비시장접근법", definition: "우간다가 제출해 UNFCCC NMA 플랫폼에 등재된 비시장접근법의 명칭입니다.", category: "climate-policy" }),
  seedV134({ id: "rcc", term: "RCC", englishName: "Regional Collaboration Centre", koreanName: "지역기후센터", definition: "유엔기후변화협약이 지역별로 운영하는 협력센터로, 6.8조 비시장접근법 워크숍·웨비나를 함께 엽니다.", category: "organisation" }),
  seedV134({ id: "sb61", term: "SB61", englishName: "61st session of the UNFCCC Subsidiary Bodies", koreanName: "유엔기후변화협약 제61차 부속기구 회의", definition: "2024년 6월 본에서 열린 유엔기후변화협약 부속기구 회의로, 6.8조 비시장접근법 제출문서가 접수된 회기입니다.", category: "climate-policy" }),
  seedV134({ id: "slcp", term: "SLCP", englishName: "Short-Lived Climate Pollutants", koreanName: "단기체류 기후오염물질", definition: "메탄·수소불화탄소·블랙카본처럼 대기 체류기간이 짧지만 온난화 영향이 큰 물질입니다.", category: "climate-risk", aliases: ["SLCPs"] }),
  seedV134({ id: "art-trees", term: "ART", englishName: "Architecture for REDD+ Transactions", koreanName: "REDD+ 거래 구조(ART)", definition: "산림 부문 감축성과(REDD+)의 크레딧 발행 기준(TREES)을 운영하는 독립 표준 기구입니다.", category: "climate-policy" }),
  seedV134({ id: "trees", term: "TREES", englishName: "The REDD+ Environmental Excellence Standard", koreanName: "REDD+ 환경우수성 표준", definition: "ART가 운영하는 국가·관할권 단위 REDD+ 크레딧 발행 표준입니다.", category: "climate-policy" }),
  seedV134({ id: "jv", term: "JV", englishName: "Joint Venture", koreanName: "합작투자", definition: "둘 이상의 기업이 지분을 나누어 함께 설립·운영하는 회사 형태입니다.", category: "trade-investment" }),
  ...
  seedV134({ id: "implementing-entity", term: "IE", englishName: "Implementing Entity", koreanName: "이행기관", definition: "적응기금 등 국제기후기금에서 사업을 직접 집행하도록 인증받은 다자·지역·국가 기관입니다.", category: "development-finance" }),
  seedV134({ id: "trwr", term: "TRWR", englishName: "Total Renewable Water Resources", koreanName: "총 재생가능 수자원", definition: "한 나라에서 해마다 다시 채워지는 지표수와 지하수의 총량으로, FAO AQUASTAT가 집계하는 수자원 지표입니다.", category: "climate-risk" }),
  seedV134({ id: "tand-vietnam", term: "TAND", englishName: "Tòa án nhân dân (People's Court)", koreanName: "인민법원", definition: "베트남의 법원 조직으로, 통계지표체계에서 재판 사건·피고인 수 지표의 소관 기관입니다.", category: "organisation" }),
  seedV134({ id: "bafu", term: "BAFU", englishName: "Bundesamt für Umwelt (Swiss Federal Office for the Environment)", koreanName: "스위스 연방환경청", definition: "스위스의 환경·기후 정책을 담당하는 연방 기관으로, 파리협정 제6.2조 양자 협력 사업의 스위스 측 주관 기관입니다.", category: "organisation" }),
  seedV134({ id: "ketep", term: "KETEP", englishName: "Korea Institute of Energy Technology Evaluation and Planning", koreanName: "한국에너지기술평가원", definition: "한국의 에너지 기술 연구개발 기획·평가·관리 전문기관입니다.", category: "organisation" }),
  seedV134({ id: "tccre", term: "TCCRE", englishName: "Typology of Climate Change Response Expenditure", koreanName: "기후변화 대응 지출 유형분류", definition: "CPEIR(2015)이 정의한 정부 지출의 기후 관련성 분류 체계로, 베트남 기후예산 태깅의 사후 분류 기준입니다.", category: "climate-policy" }),
  seedV134({ id: "tt-clear", term: "TT:CLEAR", englishName: "UNFCCC Technology Transfer Clearing House", koreanName: "UNFCCC 기술이전 정보센터", definition: "유엔기후변화협약이 운영하는 기술 수요 평가(TNA)·기술이전 정보 포털입니다.", category: "climate-policy" }),
  seedV134({ id: "vksnd-vietnam", term: "VKSND", englishName: "Viện kiểm sát nhân dân (People's Procuracy)", koreanName: "인민검찰원", definition: "베트남의 검찰 조직으로, 기소·공소 유지와 관련 통계지표의 소관 기관입니다.", category: "organisation" }),
  ...
  // V138 map targets and their source vocabulary.
  seedV134({ id: "lta", term: "LTA", englishName: "Long-Term Average", koreanName: "장기평균", definition: "여러 해의 값을 평균한 기준값입니다. 태양광 자원(1999–2018)처럼 특정 기간의 평균을 뜻합니다.", category: "climate-risk" }),
  seedV134({ id: "psmsl", term: "PSMSL", englishName: "Permanent Service for Mean Sea Level", koreanName: "평균해수면 상설관측기구", definition: "전 세계 조위 관측소의 평균해수면 기록을 모아 공개하는 국제 기구이며, 관측소 좌표의 출처입니다.", category: "climate-risk" }),
  seedV134({ id: "ctis", term: "CTIS", englishName: "Climate Technology Information System classification", koreanName: "38대 기후기술 분류", definition: "한국 기후기술 분류체계의 38개 기술 코드(CTIS-01~38)입니다. 원천이 문헌·사업에 부여한 분류를 그대로 보여줍니다.", category: "energy-technology" }),
  ...
  seedV134({ id: "rx5day", term: "RX5day", englishName: "Maximum 5-day precipitation", koreanName: "최대 5일 강수량", definition: "한 해 중 연속 5일에 내린 가장 많은 강수량입니다.", category: "climate-risk" }),
  seedV134({ id: "cwd", term: "CWD", englishName: "Consecutive Wet Days", koreanName: "연속 습윤일수", definition: "한 해 중 비가 이어진 가장 긴 연속 일수입니다.", category: "climate-risk" }),
  seedV134({ id: "ets", term: "ETS", englishName: "Emissions Trading System", koreanName: "배출권거래제", definition: "온실가스 배출허용총량을 정하고 배출권을 거래하는 제도입니다.", category: "climate-policy" }),
  seedV134({ id: "osm", term: "OSM", englishName: "OpenStreetMap", koreanName: "오픈스트리트맵", definition: "공개 참여형 지도 데이터베이스이며, 발전소 위치 일부의 출처입니다.", category: "energy-technology" }),
  seedV134({ id: "adm1", term: "ADM1", englishName: "Administrative level 1", koreanName: "1단계 행정구역(성·시)", definition: "국가 바로 아래 행정구역 단계입니다. 베트남에서는 성(tỉnh)과 중앙직할시를 뜻하며, 기후 격자 통계는 이 경계로 집계됩니다.", category: "data-format" }),
  seedV134({ id: "esa", term: "ESA", englishName: "European Space Agency", koreanName: "유럽우주국", definition: "유럽 22개국이 참여하는 우주기구이며, 토지피복 자료 WorldCover를 위성영상으로 제작해 공개합니다.", category: "organisation" }),
  seedV134({ id: "usaid", term: "USAID", englishName: "United States Agency for International Development", koreanName: "미국 국제개발처", definition: "미국 정부의 대외원조 기관이었으며 2025년 7월 업무를 종료하고 잔여 기능을 국무부로 이관했습니다.", category: "organisation" }),
  seedV134({ id: "cit", term: "CIT", englishName: "Corporate Income Tax", koreanName: "법인세", definition: "법인의 소득에 부과하는 세금입니다. 베트남 투자법령의 우대세율·면제감면은 이 세목을 기준으로 정합니다.", category: "economy" }),
  seedV134({ id: "vwem", term: "VWEM", englishName: "Vietnam Wholesale Electricity Market", koreanName: "베트남 도매전력시장", definition: "발전사업자와 전력구매자가 도매 단계에서 전력을 거래하는 베트남의 경쟁 전력시장입니다. 재생에너지 발전가격 상·하한이 이 시장 연동 여부에 따라 달리 정해집니다.", category: "energy-technology" }),
  ...
  // The final delivery prints these in public copy: the FTA registry names its
  // agreements by abbreviation, the PPP law names its contract types, and the
  // Article 6 screens name the mechanism's own procedures. Korean names for the
  // trade agreements are the 국문명 the source itself states.
  seedV134({ id: "fta-aanzfta", term: "AANZFTA", englishName: "ASEAN-Australia-New Zealand Free Trade Area", koreanName: "ASEAN-호주·뉴질랜드 FTA", definition: "ASEAN과 호주·뉴질랜드가 맺은 다자 자유무역협정입니다.", category: "trade-investment" }),
  seedV134({ id: "fta-acafta", term: "ACAFTA", englishName: "ASEAN-Canada Free Trade Agreement", koreanName: "ASEAN-캐나다 FTA", definition: "ASEAN과 캐나다가 맺은 다자 자유무역협정입니다.", category: "trade-investment" }),
  seedV134({ id: "fta-acfta", term: "ACFTA", englishName: "ASEAN-China Free Trade Area", koreanName: "ASEAN-중국 FTA", definition: "ASEAN과 중국이 맺은 다자 자유무역협정입니다.", category: "trade-investment" }),
  seedV134({ id: "fta-atiga", term: "AFTA/ATIGA", englishName: "ASEAN Trade in Goods Agreement", koreanName: "ASEAN 물품무역협정", definition: "ASEAN 회원국 사이의 물품 교역 조건을 정한 역내 협정입니다.", category: "trade-investment" }),
  seedV134({ id: "fta-ahkfta", term: "AHKFTA", englishName: "ASEAN-Hong Kong, China Free Trade Agreement", koreanName: "ASEAN-홍콩 FTA", definition: "ASEAN과 홍콩이 맺은 다자 자유무역협정입니다.", category: "trade-investment" }),
  seedV134({ id: "fta-aifta", term: "AIFTA", englishName: "ASEAN-India Free Trade Area", koreanName: "ASEAN-인도 FTA", definition: "ASEAN과 인도가 맺은 다자 자유무역협정입니다.", category: "trade-investment" }),
  seedV134({ id: "fta-ajcep", term: "AJCEP", englishName: "ASEAN-Japan Comprehensive Economic Partnership", koreanName: "ASEAN-일본 포괄적경제동반자", definition: "ASEAN과 일본이 맺은 포괄적 경제동반자 협정입니다.", category: "trade-investment" }),
  seedV134({ id: "fta-akfta", term: "AKFTA", englishName: "ASEAN-Korea Free Trade Area", koreanName: "ASEAN-한국 FTA", definition: "ASEAN과 한국이 맺은 다자 자유무역협정입니다.", category: "trade-investment" }),
  seedV134({ id: "fta-cptpp", term: "CPTPP", englishName: "Comprehensive and Progressive Agreement for Trans-Pacific Partnership", koreanName: "포괄적·점진적 환태평양경제동반자", definition: "환태평양 국가들이 참여하는 포괄적 자유무역협정입니다.", category: "trade-investment" }),
  seedV134({ id: "fta-evfta", term: "EVFTA", englishName: "EU-Viet Nam Free Trade Agreement", koreanName: "베트남-EU FTA", definition: "베트남과 유럽연합이 맺은 양자 자유무역협정입니다.", category: "trade-investment" }),
  seedV134({ id: "fta-rcep", term: "RCEP", englishName: "Regional Comprehensive Economic Partnership", koreanName: "역내포괄적경제동반자", definition: "ASEAN과 역외 5개국이 참여하는 역내 최대 규모의 자유무역협정입니다.", category: "trade-investment" }),
  seedV134({ id: "fta-ukvfta", term: "UKVFTA", englishName: "UK-Viet Nam Free Trade Agreement", koreanName: "베트남-영국 FTA", definition: "베트남과 영국이 맺은 양자 자유무역협정입니다.", category: "trade-investment" }),
  seedV134({ id: "fta-vcfta", term: "VCFTA", englishName: "Viet Nam-Chile Free Trade Agreement", koreanName: "베트남-칠레 FTA", definition: "베트남과 칠레가 맺은 양자 자유무역협정입니다.", category: "trade-investment" }),
  seedV134({ id: "fta-vifta", term: "VIFTA", englishName: "Viet Nam-Israel Free Trade Agreement", koreanName: "베트남-이스라엘 FTA", definition: "베트남과 이스라엘이 맺은 양자 자유무역협정입니다.", category: "trade-investment" }),
  seedV134({ id: "fta-vjepa", term: "VJEPA", englishName: "Viet Nam-Japan Economic Partnership Agreement", koreanName: "베트남-일본 경제동반자", definition: "베트남과 일본이 맺은 양자 경제동반자 협정입니다.", category: "trade-investment" }),
  seedV134({ id: "fta-vkfta", term: "VKFTA", englishName: "Viet Nam-Korea Free Trade Agreement", koreanName: "베트남-한국 FTA", definition: "베트남과 한국이 맺은 양자 자유무역협정입니다.", category: "trade-investment" }),
  seedV134({ id: "fta-vn-eaeu", term: "VN-EAEU", englishName: "Viet Nam-Eurasian Economic Union Free Trade Agreement", koreanName: "베트남-유라시아경제연합 FTA", definition: "베트남과 유라시아경제연합이 맺은 자유무역협정입니다.", category: "trade-investment" }),
  seedV134({ id: "fta-vn-uae", term: "VN-UAE", englishName: "Viet Nam-UAE Comprehensive Economic Partnership Agreement", koreanName: "베트남-UAE 포괄적경제동반자", definition: "베트남과 아랍에미리트가 맺은 포괄적 경제동반자 협정입니다.", category: "trade-investment" }),
  seedV134({ id: "cepa", term: "CEPA", englishName: "Comprehensive Economic Partnership Agreement", koreanName: "포괄적경제동반자협정", definition: "상품 교역뿐 아니라 서비스·투자·협력까지 함께 다루는 경제동반자 협정 형식입니다.", category: "trade-investment" }),
  seedV134({ id: "aec", term: "AEC", englishName: "ASEAN Economic Community", koreanName: "아세안경제공동체", definition: "ASEAN 회원국이 단일 시장과 생산기지를 지향해 구성한 경제공동체입니다.", category: "trade-investment" }),
  seedV134({ id: "ppp-boo", term: "BOO", englishName: "Build-Own-Operate", koreanName: "건설·소유·운영", definition: "민간이 시설을 건설해 소유하고 직접 운영하는 민관협력 계약 방식입니다.", category: "trade-investment" }),
  seedV134({ id: "ppp-bt", term: "BT", englishName: "Build-Transfer", koreanName: "건설·이전", definition: "민간이 시설을 건설한 뒤 소유권을 국가에 넘기는 민관협력 계약 방식입니다.", category: "trade-investment" }),
  seedV134({ id: "ppp-bto", term: "BTO", englishName: "Build-Transfer-Operate", koreanName: "건설·이전·운영", definition: "민간이 건설 후 소유권을 넘기고 일정 기간 운영권을 갖는 민관협력 계약 방식입니다.", category: "trade-investment" }),
  seedV134({ id: "ppp-blt", term: "BLT", englishName: "Build-Lease-Transfer", koreanName: "건설·임대·이전", definition: "민간이 건설해 임대 운영한 뒤 소유권을 국가에 넘기는 민관협력 계약 방식입니다.", category: "trade-investment" }),
  seedV134({ id: "ppp-btl", term: "BTL", englishName: "Build-Transfer-Lease", koreanName: "건설·이전·임대", definition: "민간이 건설해 소유권을 넘기고 임대료를 받아 회수하는 민관협력 계약 방식입니다.", category: "trade-investment" }),
  seedV134({ id: "paris-article-6", term: "A6", englishName: "Paris Agreement Article 6", koreanName: "파리협정 제6조", definition: "국가 간 감축실적 이전과 국제 크레딧 메커니즘을 규정한 파리협정 조항입니다.", category: "climate-policy" }),
  seedV134({ id: "a64er", term: "A6.4ER", englishName: "Article 6.4 Emission Reduction", koreanName: "제6조 4항 감축실적", definition: "파리협정 제6조 4항 메커니즘에서 발행되는 감축실적 단위입니다.", category: "climate-policy" }),
  seedV134({ id: "pacm", term: "PACM", englishName: "Paris Agreement Crediting Mechanism", koreanName: "파리협정 크레딧 메커니즘", definition: "파리협정 제6조 4항에 따라 유엔이 운영하는 국제 감축 크레딧 제도입니다.", category: "climate-policy" }),
  seedV134({ id: "hpa", term: "HPA", englishName: "Host Party Approval", koreanName: "유치국 승인", definition: "감축사업이 이루어지는 국가가 국제 이전을 승인하는 절차입니다.", category: "climate-policy" }),
  seedV134({ id: "pcn", term: "PCN", englishName: "Prior Consideration Notification", koreanName: "사전검토 통보", definition: "감축사업을 국제 메커니즘에 등록하기 전에 제출하는 사전 검토 통보입니다.", category: "climate-policy" }),
  seedV134({ id: "corresponding-adjustment", term: "CA", englishName: "Corresponding Adjustment", koreanName: "상응조정", definition: "감축실적을 국가 간에 이전할 때 이중계상을 막기 위해 배출량 장부를 맞추는 조정입니다.", category: "climate-policy" }),
  seedV134({ id: "implementation-agreement", term: "IA", englishName: "Implementation Agreement", koreanName: "이행협정", definition: "협력 각서 이후 실제 이행 조건을 구속력 있게 정한 협정입니다.", category: "climate-policy" }),
  seedV134({ id: "nfp", term: "NFP", englishName: "National Focal Point", koreanName: "국가연락창구", definition: "국제 협약의 이행을 위해 각국이 지정한 공식 연락 창구입니다.", category: "climate-policy" }),
  seedV134({ id: "ncm", term: "NCM", englishName: "National Crediting Mechanism", koreanName: "국가 크레딧 제도", definition: "한 국가가 자국 안에서 감축실적을 발행·관리하기 위해 운영하는 제도입니다.", category: "climate-policy" }),
  seedV134({ id: "ndc2020", term: "NDC2020", englishName: "Nationally Determined Contribution (2020 update)", koreanName: "2020년 갱신 국가결정기여", definition: "베트남이 2020년에 유엔에 제출한 갱신 국가결정기여 문서입니다.", category: "climate-policy" }),
  seedV134({ id: "ndc2022", term: "NDC2022", englishName: "Nationally Determined Contribution (2022 update)", koreanName: "2022년 갱신 국가결정기여", definition: "베트남이 2022년에 유엔에 제출한 갱신 국가결정기여 문서입니다.", category: "climate-policy" }),
  seedV134({ id: "btr1", term: "BTR1", englishName: "First Biennial Transparency Report", koreanName: "제1차 격년투명성보고서", definition: "파리협정 투명성 체계에 따라 각국이 제출하는 첫 격년 이행보고서입니다.", category: "climate-policy" }),
  seedV134({ id: "snc", term: "SNC", englishName: "Second National Communication", koreanName: "제2차 국가보고서", definition: "기후변화협약에 따라 각국이 제출하는 두 번째 국가보고서입니다.", category: "climate-policy" }),
  seedV134({ id: "ar5", term: "AR5", englishName: "IPCC Fifth Assessment Report", koreanName: "IPCC 제5차 평가보고서", definition: "2014년 발간된 IPCC 제5차 평가보고서로, 지구온난화지수 값의 근거로 인용됩니다.", category: "climate-policy" }),
  seedV134({ id: "erpa", term: "ERPA", englishName: "Emission Reductions Payment Agreement", koreanName: "배출감축 구매계약", definition: "감축 실적을 사전에 정한 조건으로 사고파는 계약입니다.", category: "climate-policy" }),
  seedV134({ id: "gmp", term: "GMP", englishName: "Global Methane Pledge", koreanName: "글로벌 메탄서약", definition: "2030년까지 메탄 배출을 2020년 대비 30% 줄이기로 한 국제 서약입니다.", category: "climate-policy" }),
  seedV134({ id: "cca", term: "CCA", englishName: "Climate Change Adaptation", koreanName: "기후변화 적응", definition: "이미 일어난 기후변화의 영향에 대비해 피해를 줄이는 정책과 조치입니다.", category: "climate-policy" }),
  seedV134({ id: "epr", term: "EPR", englishName: "Extended Producer Responsibility", koreanName: "생산자책임재활용", definition: "생산자가 제품 폐기 단계의 회수·재활용까지 책임지도록 하는 제도입니다.", category: "climate-policy" }),
  seedV134({ id: "lep", term: "LEP", englishName: "Law on Environmental Protection", koreanName: "환경보호법", definition: "베트남의 환경 보호 기본법으로, 폐기물·배출·평가 제도의 근거가 됩니다.", category: "climate-policy" }),
  seedV134({ id: "doe-cdm", term: "DOE", englishName: "Designated Operational Entity", koreanName: "지정운영기구", definition: "감축사업의 타당성 확인과 검증을 수행하도록 지정된 제3자 기관입니다.", category: "climate-policy" }),
  seedV134({ id: "cclw", term: "CCLW", englishName: "Climate Change Laws of the World", koreanName: "세계 기후변화 법령 데이터베이스", definition: "각국의 기후 관련 법령과 정책 문서를 수집·공개하는 데이터베이스입니다.", category: "climate-policy" }),
  ...
  seedV134({ id: "dppa", term: "DPPA", englishName: "Direct Power Purchase Agreement", koreanName: "직접전력구매계약", definition: "전력 소비자가 발전사업자와 직접 맺는 전력 구매 계약입니다.", category: "energy-technology" }),
  seedV134({ id: "ppa", term: "PPA", englishName: "Power Purchase Agreement", koreanName: "전력구매계약", definition: "발전사업자와 구매자가 전력의 가격과 기간을 정해 맺는 계약입니다.", category: "energy-technology" }),
  seedV134({ id: "esco", term: "ESCO", englishName: "Energy Service Company", koreanName: "에너지절약전문기업", definition: "에너지 절감 설비 투자를 대신하고 절감액으로 회수하는 사업자입니다.", category: "energy-technology" }),
  seedV134({ id: "chp", term: "CHP", englishName: "Combined Heat and Power", koreanName: "열병합발전", definition: "전기와 열을 한 설비에서 함께 생산해 연료 이용률을 높이는 방식입니다.", category: "energy-technology" }),
  seedV134({ id: "cfl", term: "CFL", englishName: "Compact Fluorescent Lamp", koreanName: "소형 형광램프", definition: "백열등을 대체하는 소형 형광 조명으로, 조명 효율 개선 사업에 쓰입니다.", category: "energy-technology" }),
  seedV134({ id: "brt", term: "BRT", englishName: "Bus Rapid Transit", koreanName: "간선급행버스체계", definition: "전용 차로와 우선 신호로 버스를 지하철처럼 운영하는 대중교통 방식입니다.", category: "energy-technology" }),
  seedV134({ id: "eor", term: "EOR", englishName: "Enhanced Oil Recovery", koreanName: "원유회수증진", definition: "가스나 물을 주입해 유전의 잔여 원유 회수율을 높이는 기술입니다.", category: "energy-technology" }),
  seedV134({ id: "cod-date", term: "COD", englishName: "Commercial Operation Date", koreanName: "상업운전 개시일", definition: "발전설비가 시험을 마치고 상업 운전을 시작한 날짜입니다.", category: "energy-technology" }),
  seedV134({ id: "energy-efficiency", term: "EE", englishName: "Energy Efficiency", koreanName: "에너지 효율", definition: "같은 성과를 더 적은 에너지로 얻도록 설비와 운영을 개선하는 분야입니다.", category: "energy-technology" }),
  seedV134({ id: "cems", term: "CEMS", englishName: "Continuous Emission Monitoring System", koreanName: "굴뚝 자동측정장치", definition: "배출구에서 오염물질 농도를 상시 실측하는 장치입니다.", category: "energy-technology" }),
  seedV134({ id: "nfb", term: "NFB", englishName: "Non-Fired Brick", koreanName: "비소성 벽돌", definition: "굽지 않고 굳혀 만들어 소성 연료를 쓰지 않는 벽돌입니다.", category: "energy-technology" }),
  seedV134({ id: "hcfc", term: "HCFC", englishName: "Hydrochlorofluorocarbon", koreanName: "수소염화불화탄소", definition: "오존층 파괴 물질로 몬트리올 의정서에 따라 사용이 단계적으로 줄어드는 냉매입니다.", category: "energy-technology" }),
  seedV134({ id: "kea", term: "KEA", englishName: "Korea Energy Agency", koreanName: "한국에너지공단", definition: "한국의 에너지 효율과 신재생에너지 보급을 담당하는 준정부기관입니다.", category: "organisation" }),
  seedV134({ id: "meti", term: "METI", englishName: "Ministry of Economy, Trade and Industry", koreanName: "일본 경제산업성", definition: "일본의 산업·통상·에너지 정책을 담당하는 중앙부처입니다.", category: "organisation" }),
  seedV134({ id: "mti-vietnam", term: "MTI", englishName: "Ministry of Industry and Trade", koreanName: "베트남 산업무역부", definition: "베트남의 산업·에너지·통상 정책을 담당하는 중앙부처입니다.", category: "organisation" }),
  seedV134({ id: "donre", term: "DONRE", englishName: "Department of Natural Resources and Environment", koreanName: "성 자원환경국", definition: "베트남 각 성·시에서 자원·환경 업무를 담당하는 지방 행정기관입니다.", category: "organisation" }),
  seedV134({ id: "vea", term: "VEA", englishName: "Viet Nam Environment Administration", koreanName: "베트남 환경총국", definition: "베트남의 환경 관리와 오염 통제를 담당하는 총국입니다.", category: "organisation" }),
  seedV134({ id: "ubnd", term: "UBND", englishName: "Uy ban nhan dan (People's Committee)", koreanName: "인민위원회", definition: "베트남 지방정부의 집행기관으로, 결정문(Quyết định)을 발령합니다.", category: "organisation" }),
  seedV134({ id: "vigmr", term: "VIGMR", englishName: "Viet Nam Institute of Geosciences and Mineral Resources", koreanName: "베트남 지질광물자원연구원", definition: "베트남의 지질 조사와 광물자원 연구를 수행하는 국가 연구기관입니다.", category: "organisation" }),
  seedV134({ id: "lse", term: "LSE", englishName: "London School of Economics and Political Science", koreanName: "런던정치경제대학교", definition: "기후법령 데이터베이스를 운영하는 그랜섬연구소가 속한 영국 대학입니다.", category: "organisation" }),
  seedV134({ id: "vepg", term: "VEPG", englishName: "Viet Nam Energy Partnership Group", koreanName: "베트남 에너지 파트너십 그룹", definition: "베트남 정부와 개발 파트너가 에너지 정책을 협의하는 협력체입니다.", category: "organisation" }),
  seedV134({ id: "isa", term: "ISA", englishName: "International Solar Alliance", koreanName: "국제태양광연합", definition: "태양광 보급 확대를 위해 각국이 참여하는 국제 협력체입니다.", category: "organisation" }),
  seedV134({ id: "gfei", term: "GFEI", englishName: "Global Fuel Economy Initiative", koreanName: "글로벌 연비 이니셔티브", definition: "자동차 연비 개선을 국제적으로 추진하는 협력 사업입니다.", category: "organisation" }),
  seedV134({ id: "fff", term: "FFF", englishName: "Forest and Farm Facility", koreanName: "산림·농가 지원기구", definition: "산림과 농가 조직의 기후 대응 역량을 지원하는 국제 기구입니다.", category: "organisation" }),
  seedV134({ id: "ccac", term: "CCAC", englishName: "Climate and Clean Air Coalition", koreanName: "기후·청정대기 연합", definition: "메탄 등 단기 체류 기후오염물질 감축을 추진하는 국제 연합체입니다.", category: "organisation" }),
  seedV134({ id: "ppca", term: "PPCA", englishName: "Powering Past Coal Alliance", koreanName: "탈석탄 동맹", definition: "석탄발전의 단계적 폐지를 약속한 국가·기관의 국제 동맹입니다.", category: "organisation" }),
  seedV134({ id: "gppd", term: "GPPD", englishName: "Global Power Plant Database", koreanName: "글로벌 발전소 데이터베이스", definition: "전 세계 발전소의 위치·연료·용량을 공개하는 데이터베이스입니다.", category: "organisation" }),
  seedV134({ id: "rmp", term: "RMP", englishName: "Resource Mobilization Plan", koreanName: "자원동원계획", definition: "합의된 협력 사업에 필요한 재원을 어떻게 확보할지 정한 계획입니다.", category: "development-finance" }),
  seedV134({ id: "technical-assistance", term: "TA", englishName: "Technical Assistance", koreanName: "기술지원", definition: "자금 지원이 아니라 전문 인력·자문·교육으로 제공하는 협력 형태입니다.", category: "development-finance" }),
  seedV134({ id: "retf", term: "RETF", englishName: "Recipient-Executed Trust Fund", koreanName: "수원국 집행 신탁기금", definition: "수원국이 직접 집행하도록 설계된 세계은행 신탁기금 형식입니다.", category: "development-finance" }),
  seedV134({ id: "ksp", term: "KSP", englishName: "Knowledge Sharing Program", koreanName: "경제발전경험공유사업", definition: "한국의 개발 경험을 협력국과 공유하는 정책자문 사업입니다.", category: "development-finance" }),
  seedV134({ id: "nhsfo", term: "NHSFO", englishName: "Non-Honoring of Sovereign Financial Obligations", koreanName: "국가 재정의무 불이행", definition: "국가나 공공기관이 확정된 지급 의무를 이행하지 않는 위험을 담보하는 보증 유형입니다.", category: "development-finance" }),
  seedV134({ id: "project-manager", term: "PM", englishName: "Project Manager", koreanName: "사업관리자", definition: "사업의 일정·인력·품질을 총괄해 책임지는 관리자입니다.", category: "development-finance" }),
  seedV134({ id: "mcda", term: "MCDA", englishName: "Multi-Criteria Decision Analysis", koreanName: "다기준 의사결정분석", definition: "여러 평가 기준에 가중치를 두어 대안을 비교하는 분석 방법입니다.", category: "data-format" }),
  seedV134({ id: "ocr", term: "OCR", englishName: "Optical Character Recognition", koreanName: "광학문자인식", definition: "스캔한 이미지에서 글자를 읽어 문자 데이터로 바꾸는 기술입니다.", category: "data-format" }),
