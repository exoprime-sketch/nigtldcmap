...
export const PUBLIC_INDICATOR_INTERPRETATIONS_V129: readonly PublicIndicatorInterpretationV129[] =
  Object.freeze([
    ...
    },
    {
      ...
      publicUnit: "지수",
      meaningBullets: [
        "소득이나 소비지출이 사람들 사이에 얼마나 불균등하게 분포하는지 보여줍니다.",
        "0에 가까울수록 평등하고 100에 가까울수록 불평등이 큽니다.",
        "소득 기준과 소비지출 기준 값은 같은 기준 안에서 비교합니다.",
      ],
      scale: {
        minimum: 0,
        maximum: 100,
      ...
      directionLabel: "높을수록 소득·소비지출의 불평등이 큼",
      officialBands: null,
      benchmarkType: "none",
    },
    {
      elementId: "A-013",
      explanationRequired: true,
      publicName: "NDC–SDG 연계",
      publicUnit: "건",
      meaningBullets: [
        "국가 온실가스 감축·적응 문안이 지속가능발전목표와 어떻게 연결되는지 보여줍니다.",
        "연계 건수는 문안과 목표의 연결 수이며 정책 성과점수나 달성률이 아닙니다.",
        "부문·대응유형·이행상태별 분류는 같은 연결 자료를 서로 다른 기준으로 집계합니다.",
      ],
      direction: "neutral",
      directionLabel: "건수의 많고 적음만으로 정책 성과를 판정하지 않음",
      officialBands: null,
      benchmarkType: "none",
      numerator: "NDC 문안과 SDG 목표·세부목표의 검증된 연결 건수",
    },
    {
      elementId: "A-014",
      explanationRequired: true,
    ...
    },
    {
      elementId: "C-018",
      explanationRequired: true,
      publicName: "중장기 전력 계획·전망(개정 PDP8)",
      meaningBullets: [
        "베트남 총리 결정(Quyết định 768/QĐ-TTg, 개정 PDP8)이 제시한 2030·2050년 전원별 설비용량, 수요, 재생에너지 비중, 배출 전망입니다. 값은 단일 계획의 하한~상한 범위이며 시나리오 비교나 연도 사이 추세가 아닙니다.",
        "함께 수록된 전력가격 규정(소매가격 밴드, 기술별 발전가격 상한, 수입전력 상한)은 VND/kWh·UScent/kWh 단위와 가격 종류가 다르므로 같은 단위·종류 안에서만 비교합니다.",
      ],
      direction: "context-dependent",
      directionLabel: "같은 계획 문서·연도·단위 안에서 해석",
      officialBands: null,
      benchmarkType: "none",
    },
    {
      elementId: "C-019",
      explanationRequired: true,
      publicName: "탄소시장 제도·운영 현황",
      meaningBullets: [
        "탄소세, 배출권거래제, 시장가격, 대상부문과 관련 법령을 항목별로 보여줍니다.",
        "금액·배출량·비율·시행상태는 단위와 의미가 달라 하나의 점수나 축으로 합치지 않습니다.",
        "정책 시점은 법령과 공개자료에 기재된 기준일·기간으로 확인합니다.",
      ],
      direction: "context-dependent",
      directionLabel: "선택한 제도·가격·범위 항목의 정의와 단위에 따라 해석",
      officialBands: null,
      benchmarkType: "none",
    },
    {
    ...
    },
    {
      elementId: "D-010",
      explanationRequired: true,
      publicName: "화석연료 보조금 규모",
      meaningBullets: [
        "보조금 총액, GDP 대비 비중, 연료별 구성비와 외부효과를 반영한 효율가격을 구분해 보여줍니다.",
        "총액·비중·리터당 가격은 단위와 분모가 달라 같은 축에서 직접 비교하지 않습니다.",
    ...
    },
    {
      elementId: "E-011",
      explanationRequired: true,
      publicName: "기술준비수준(TRL)",
      publicUnit: "등급",
      meaningBullets: [
        "기술이 기초 연구부터 실제 운영까지 어느 개발 단계에 있는지 구분하는 등급입니다.",
        "등급이 높을수록 실증과 상용화에 가까운 단계를 뜻하지만 기술의 우수성 점수는 아닙니다.",
        "현재 실제 입력값이 없어 등급을 임의로 표시하지 않습니다.",
      ],
      direction: "context-dependent",
      directionLabel: "높은 등급은 상용화 단계에 가까움을 뜻하며 기술 성과순위는 아님",
      officialBands: null,
      benchmarkType: "none",
    },
    {
    ...
    },
    {
      elementId: "E-014",
      explanationRequired: true,
      publicName: "양자 기후협력 협정",
      publicUnit: "건(협정)",
      meaningBullets: [
        "기후변화 협력 기본협정과 공동위원회의 체결·운영 상태를 보여줍니다.",
        "협정 건수는 협력의 제도적 기반을 뜻하며 기술역량이나 사업성과 점수가 아닙니다.",
        "발효·운영 상태와 대상 분야는 각 협정의 공식 원문을 기준으로 확인합니다.",
      ],
      direction: "neutral",
      directionLabel: "협정 수의 많고 적음에 성과순위를 부여하지 않음",
      officialBands: null,
      benchmarkType: "none",
    },
    {
