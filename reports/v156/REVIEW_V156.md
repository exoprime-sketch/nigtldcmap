...
2026-09-22 입고분(워크북 146개·요소코드 145개 + B-012 geojson)은 값 갱신이 아니라 상당 부분 **구조 재설계**였다. 게이트로 하나씩 확인한 끝에 현행 화면·계약·용량 한도가 그대로 읽을 수 있는 **5개 요소만 적용**하고, 나머지는 이전 입고분 값을 유지(보류)했다. 값 조작·기대값 변경은 한 건도 하지 않았고, 갱신 절차는 1명령 런북으로 고정했다.

### 1.1 요소 152개 집계

| 구분 | 요소 수 | 내용 |
|---|---|---|
| **변경 적용** | **5** | A-002 · B-015 · B-022 · E-001 · E-010 (§3) |
| **동일 — 채택해도 공개 트리 무변화** | **22** | A-015 · A-017 · A-022 · A-033 · B-014 · B-018 · B-019 · B-020 · B-021 · B-025 · D-002 · D-004 · D-006 · D-012 · D-017 · D-020 · D-021 · D-022 · D-023 · D-024 · E-003 · E-004 |
| **변경 보류** | **118** | 사유별 §1.2 |
| **미납품 → carry-over** | **7** | 원천 없음 3(C-020 · C-021 · C-023) / 이전 워크북 유지 4(E-011 · E-013 · E-016 · E-017) |
| 합계 | 152 | 프레임워크 요소 |

"동일 22개"는 행수·연도 일치만으로 판정하지 않았다. 22개를 채택한 스테이징 트리를 실제로 빌드해 현재 공개 트리와 요소별 diff를 돌려 **변화 0**을 확인했다(같은 검증에서 B-027·E-005·E-006·E-015·E-019는 값은 같아도 지표 메타가 늘어 보류로 옮겼다).

### 1.2 변경 보류 118개 — 사유별

| 사유 | 요소 수 | 요소 |
|---|---|---|
| 값 외 변화(지표·속성·상태 포함) — 이번 라운드 범위 밖 | 60 | A-001 · A-003 · A-004 · A-005 · A-006 · A-007 · A-008 · A-009 · A-010 · A-011 · A-012 · A-014 · A-016 · A-018 · A-019 · A-020 · A-021 · A-024 · A-027 · A-030 · A-031 · A-032 · B-001 · B-003 · B-008 · B-010 · B-011 · B-012 · B-013 · B-016 · B-017 · B-026 · B-029 · B-030 · B-037 · B-038 · B-039 · B-040 · B-041 · B-042 · B-044 · B-048 · C-001 · D-001 · D-003 · D-005 · D-007 · D-008 · D-009 · D-010 · D-011 · D-013 · D-014 · D-015 · D-016 · D-019 · D-025 · D-026 · E-014 · E-020 |
| 구조·그레인 변경 | 15 | A-013 · A-023 · A-028 · B-002 · B-005 · B-024 · B-031 · B-032 · B-033 · B-034 · B-035 · B-036 · C-016 · D-018 · E-008 |
| 공개 명칭 자리에 내부 레코드 키 | 12 | C-003 · C-005 · C-006 · C-007 · C-015 · C-017 · E-002 · E-007 · E-009 · A-025 · A-029 · C-025 |
...
| 지표 메타만 변화(값·행수 동일) | 5 | B-027 · E-005 · E-006 · E-015 · E-019 |
| 지도 선언 변수 소실 | 5 | C-012 · C-013 · C-019 · C-022 · C-024 |
| 다운로드 파일 100 MB 한도 초과 | 3 | B-004 · B-006 · B-007 |
| 지표 ID 체계 변경(`_nat` 접미) | 1 | E-012 |
| 시간 계약 불일치 | 1 | B-045 |
| 용어 미등록(`WWF BRF`) | 1 | B-009 |

기계 판독용 정본은 `reports/v156/hold-list-v156.json`. 제공자 회신이 필요한 4건은 `docs/handoff/v156/DATA_PROVIDER_REQUEST_20260924.md`.
